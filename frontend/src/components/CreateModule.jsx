...
export default function CreateModule() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();// to disable defoult browser behaviour of refreshing the page on form submit
    /*
    http response code:
     200 ok, 
     201 created, 
    ...
    try {
      ...
      // dry: don't repeat yourself, if you find yourself writing the same code more than once, consider refactoring it into a function or component to improve maintainability and reduce errors.
